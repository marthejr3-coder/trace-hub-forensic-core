...
import { PacoteEvidenciaSteps } from '@/pages/PacoteEvidencia';
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-10 max-w-3xl">
          ...
          {/* Pacote de Evidência Digital (mesclado) */}
          <div className="mt-10 mb-4">
            <div className="flex items-center gap-2 mb-2">
              <ShieldCheck className="w-5 h-5 text-emerald-500" />
              <h2 className="text-xl sm:text-2xl font-bold">Pacote de Evidência Digital</h2>
            </div>
            <p className="text-sm text-muted-foreground">
              Monte um pacote completo: verifique TSR (RFC 3161), OTS (OpenTimestamps / Bitcoin) e aplique carimbo PAdES no PDF do laudo.
            </p>
          </div>
